...
public class WpmDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Pet>().HasData(
                    new Pet() { Id = 1, Name = "Gianni", Age = 11, Weight = 19, PhotoUrl= "https://wisdompetmedicinestorage.blob.core.windows.net/photos/gianni.jpg", BreedId = 1 },
                    new Pet() { Id = 2, Name = "Nina", Age = 9, Weight = 24, PhotoUrl = "https://wisdompetmedicinestorage.blob.core.windows.net/photos/nina.jpg", BreedId = 1 },
                    new Pet() { Id = 3, Name = "Cati", Age = 10, Weight = 33.5m, PhotoUrl = "https://wisdompetmedicinestorage.blob.core.windows.net/photos/cati.jpg", BreedId = 2 },
